...
# Set paths for the UMAP images (folders: 'Low_risk', 'High_risk')
...
# Load the ResNet50 base model pre-trained on ImageNet, excluding its top layers
base_model = ResNet50(weights='imagenet', include_top=False, input_shape=(224, 224, 3))

# Freeze the ResNet50 base model to prevent its weights from being updated during training
...
# Create the final model by combining the ResNet50 base and the custom head
